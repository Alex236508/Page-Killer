...
## bookmarklet:
###### This version will auto update if i change the file (is vunerable to CORS policy block)
```javascript
...
###### This version will not update but will get through CORS policy block and other security features
```javascript
